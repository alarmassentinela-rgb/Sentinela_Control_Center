...
# D3d — scheduler / frescura
EVT_PRICE_CHANGED = "PriceChanged"
EVT_STOCK_CHANGED = "StockChanged"
EVT_PRODUCT_EXPIRED = "ProductExpired"
EVT_PRODUCT_REFRESHED = "ProductRefreshed"
EVT_CATALOG_EXPIRED = "CatalogExpired"
...
ALL_EVENTS = frozenset({
    ...
    EVT_PRICE_CHANGED, EVT_STOCK_CHANGED, EVT_PRODUCT_EXPIRED,
    EVT_PRODUCT_REFRESHED, EVT_CATALOG_EXPIRED,
})
